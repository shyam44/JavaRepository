package com.java8.examples.timeapi;
...
public class TimeApiTest {
	...
	assertEquals(11, between.getMonths());
	...
	assertEquals(11, betweenJoda.getMonths());
    }
	...
	assertEquals(19800, zonedDateTimeEurope.getOffset().getTotalSeconds());
	assertEquals("Asia/Calcutta", zonedDateTimeEurope.getZone().getId());
	...
	assertEquals(19800 * 1000, dateTimeEuropeJoda.getZone().getOffset(dateTimeEuropeJoda.getMillis()));
	assertEquals("Asia/Kolkata", dateTimeEuropeJoda.getZone().getID());
